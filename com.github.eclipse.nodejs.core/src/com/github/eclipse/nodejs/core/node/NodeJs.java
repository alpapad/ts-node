...
public class NodeJs {
    ...
    protected NodeJs(String id, String name, File nodeJs, File npm, File tsLibFolder) {
        super();
        this.id = id;
        this.name = name;
        this.nodeJs = nodeJs;
        ...
        this.typingsLocation = new File(Ts.getGlobalTypingsCacheLocation("2.6"));
    }
    ...
    public NodeJs(IConfigurationElement element) throws IOException {
        ...
        this.tsLibFolder = getRelativeToPlugin(NodeJsCorePlugin.PluginId, "node_modules/typescript/lib");
        this.typingsLocation = new File(Ts.getGlobalTypingsCacheLocation("2.6"));
    }
    ...
    public File getTsLibFolder() {
        try {
            return getRelativeToPlugin(NodeJsCorePlugin.PluginId, "node_modules/typescript/lib");
        } catch (IOException e) {
    ...
    public String toString() {
        return "NodeJs [id=" + id + ", name=" + name + ", nodeJs=" + nodeJs + ", npm=" + npm + ", tsLibFolder=" + tsLibFolder + ", getId()=" + getId() + ", getName()=" + getName()
                + ", getNodeJs()=" + getNodeJs() + ", getNpm()=" + getNpm() + ", getTsLibFolder()=" + getTsLibFolder() + "]";
    }
